...
?>
<nav class="govuk-pagination dgwltd-pagination govuk-pagination--pages<?php echo ( empty( $prev_id ) ? ' govuk-pagination--noprev' : '' ); ?><?php echo ( empty( $next_id ) ? ' govuk-pagination--nonext' : '' ); ?>" aria-label="Pagination">
	<ul class="govuk-pagination__list">

	<?php if ( ! empty( $prev_id ) ) : ?>
		<li class="govuk-pagination__item govuk-pagination__item--previous">
		<a href="<?php echo esc_url( get_permalink( $prev_id ) ); ?>" class="govuk-pagination__link" rel="prev">
			<span class="govuk-pagination__link-title">
			<svg class="govuk-pagination__link-icon" xmlns="http://www.w3.org/2000/svg" height="13" width="17" viewBox="0 0 17 13">
			  <path d="m6.5938-0.0078125-6.7266 6.7266 6.7441 6.4062 1.377-1.449-4.1856-3.9768h12.896v-2h-12.984l4.2931-4.293-1.414-1.414z"></path>
			</svg>
			<span class="govuk-pagination__link-text">
	...
	<?php if ( ! empty( $next_id ) ) : ?>
		<li class="govuk-pagination__item govuk-pagination__item--next" rel="next">
		<a href="<?php echo esc_url( get_permalink( $next_id ) ); ?>" class="govuk-pagination__link">
			<span class="govuk-pagination__link-title">
			<svg class="govuk-pagination__link-icon" xmlns="http://www.w3.org/2000/svg" height="13" width="17" viewBox="0 0 17 13">
