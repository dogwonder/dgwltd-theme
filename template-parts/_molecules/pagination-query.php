...
?>
<nav class="govuk-pagination dgwltd-pagination flex-center" aria-label="Pagination">
...
<?php
	...
	<li class="govuk-pagination__item govuk-pagination__item--previous">
		<a href="<?php echo esc_url( $prev_url ); ?>" class="govuk-pagination__link" rel="prev">
			...
			<span class="govuk-pagination__link-label"><?php echo absint( $paged - 1 ); ?> of <?php echo absint( $total_pages ); ?></span>
		</a>
	</li>
	<?php endif; ?>
	<?php
	...
	<li class="govuk-pagination__item govuk-pagination__item--next">
		<a href="<?php echo esc_url( $next_url ); ?>" class="govuk-pagination__link" rel="next">
			<span class="govuk-pagination__link-title">
			<svg class="govuk-pagination__link-icon" xmlns="http://www.w3.org/2000/svg" height="13" width="17" viewBox="0 0 17 13">
